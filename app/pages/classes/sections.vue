...
// components/menu/index.vue's "Classes" group), but with no guard here, anyone who reached
// /classes/sections directly (e.g. a Teacher or Accountant) could see and use the full section
// management UI, not just be unable to find it in their own menu.
definePageMeta({
