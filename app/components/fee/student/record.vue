            ...
            <div class="space-y-4">
                <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        />
                        <div>
                            <p class="text-lg font-semibold">{{ student.givenNames }} {{ student.familyName }}'s Fees</p>
                            <p class="text-xs text-muted mt-0.5">Live summary of assigned fees, payments, and discounts.</p>
                        </div>
                    </div>
