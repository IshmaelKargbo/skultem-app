          ...
          <UCard class="sticky top-0">
            <div class="space-y-4">
              ...
              <UAlert
                ...
                description="Who this fee applies to (class or students) and its type were set when it was created and can't be edited. Delete and recreate it instead if that needs to change."
              />
            </div>
            <template #footer>
