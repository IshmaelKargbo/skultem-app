      ...
      >
        ...
        <UFormField label="Name" name="name" required>
          <UInput
            v-model="state.name"
            icon="i-lucide-tag"
            placeholder="e.g. Discount for Aruna Kargbo - First Term"
          />
          <template #help>
        ...
        <UFormField label="Fee Category" name="feeId" required>
          ...
          <USelect
            ...
            @change="changeFee"
            :disabled="isLoading && !state.studentId"
          />
          <template #help>
        ...
        <UFormField label="Reason" name="reason" required>
          ...
          <UInput
            ...
            placeholder="Example: Scholarship award"
            :disabled="isLoading"
          />
          <template #help>
...
const categories = ref<
  { label: string; value: string; outstanding: string; total: string; name: string }[]
>([]);
