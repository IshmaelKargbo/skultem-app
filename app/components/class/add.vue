<template>
    <USlideover :dismissible="false" :open="open" @update:open="open = $event">
        ...
        <template #body>
            <UForm ref="formRef" :schema="schema" :state="state" class="space-y-4 sm:space-y-5" @submit.prevent="onSubmit">
                <!-- Name -->
        ...
        <template #footer>
            <div class="flex flex-col gap-3 sm:flex-row">
                <UButton class="justify-center" :icon="SAVE_ICON" label="Save" :loading="isLoading" @click="formRef?.submit()" />
